<?php
	...
	if(isset($_POST['signup'])){
		...
		if(!isset($_SESSION['captcha'])){
			...
			if (!$resp->isSuccess()){
		  		$_SESSION['error'] = 'Click on the checkbox to verify recaptcha.';
			...
			if($row['numrows'] > 0){
				...
				try{
					...
					$message = "
						...
						<a href='http://localhost/Ecommerce2/ecommerce/activate.php?code=".$code."&user=".$userid."'>Activate Account</a>
					";
				    ...
				    try {
				        ...
				        $mail->addReplyTo('your email here');
